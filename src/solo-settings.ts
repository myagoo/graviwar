...
export const numericSettings = {
  ...
  shieldSeconds: { label: "Shield duration (seconds)", min: 1, max: 15, step: 1, default: 5 },
...
export const settingsSections = [
  ...
  { label: "Items", keys: ["surgePull", "surgeSeconds", "shieldSeconds", "jetBoost", "jetSeconds", "superPull", "superRadius", "superSeconds", "superTransitionMs", "superWeight"] },
