...
const CACHE = 'graviwar-c06c8c07d08b5f34';
const FILES = ["assets/index-DiiiCkgO.js","assets/index-_SMhlwKy.css","icons/apple-touch-icon.png","icons/favicon-32.png","icons/icon-192.png","icons/icon-512.png","icons/maskable-512.png","index.html","manifest.json"];
